                                    ...
                                    ORDER BY cr.date_requested DESC";
                                            ...
                                            while ($row = $result->fetch_assoc()):
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-success btn-xs update-status"
                                                            title="For Signature" data-id="<?= $row['id'] ?>"
                                                            data-status="For Signature">
                                                            <span class="glyphicon glyphicon-pencil"></span>
                                                        </button>
                                                        <button class="btn btn-danger btn-xs update-status"
                                                            title="For Payment" data-id="<?= $row['id'] ?>"
                                                            data-status="For Payment">
                                                            <span class="glyphicon glyphicon-usd"></span>
                                                        </button>
                                                        <button class="btn btn-primary btn-xs update-status" title="Cleared"
                                                            data-id="<?= $row['id'] ?>" data-status="Cleared">
                                                            <span class="glyphicon glyphicon-ok"></span>
                                                        </button>
                                                        <button type="button"
                                                            class="btn btn-warning btn-xs open-balance-modal"
                                                            title="Edit Balance" data-toggle="modal"
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                setTimeout(function () {
                                    location.reload();
                                }, 1250); // reload after SweetAlert closes
                            },
