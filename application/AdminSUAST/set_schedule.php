...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['id'], $_POST['examTime'], $_POST['examDate'])) {
    ...
    // Debug
    echo "Attempting to update exam_time and exam_date for ID: $id<br>";
    echo "Time: $examTime, Date: $examDate<br>";
    ...
    if ($stmt->execute()) {
        echo "✅ Exam time and date updated successfully for ID: $id";
    } else {
