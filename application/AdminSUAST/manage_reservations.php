                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="setScheduleModalLabel">Set Exam Time</h5>
                                    ...
                                    <form id="setScheduleForm">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="examTime" id="examTime" required>
                                                <option value="selectedExamTime">Selected Exam Time</option>

                                                <!-- Options will be populated dynamically using PHP and AJAX -->
                                            </select>
                                        </div>

                                        <button type="submit" class="btn btn-primary">Set Exam Time</button>
                                    </form>
                                </div>
                            </div>
                        </div>
