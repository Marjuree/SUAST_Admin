...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($requestId && $status) {
        ...
        if ($stmt->execute()) {
            ...
            <script>
                Swal.fire({
                    ...
                    window.location.href = 'leave_request.php'; // Redirect to service_request.php
                });
            </script>";
        } else {
            // SweetAlert error
            ...
            <script>
                Swal.fire({
                    ...
                    window.location.href = 'leave_request.php'; // Redirect to service_request.php in case of failure
                });
            </script>";
        }
        ...
        <script>
            Swal.fire({
                ...
                window.location.href = 'leave_request.php'; // Redirect to service_request.php in case of missing data
            });
        </script>";
    }
} else {
    ...
    <script>
        Swal.fire({
            ...
            window.location.href = 'leave_request.php'; // Redirect to service_request.php in case of invalid request method
        });
    </script>";
}
